...
function showLoginScreen() {
  ...
  h += '<svg width="48" height="48" viewBox="0 0 32 32" style="margin-bottom:8px"><polygon points="16,3 28,14 16,29 4,14" fill="none" stroke="#c8a84e" stroke-width="1.2"/><line x1="4" y1="14" x2="28" y2="14" stroke="#c8a84e" stroke-width="0.6"/><line x1="16" y1="3" x2="11" y2="14" stroke="#c8a84e" stroke-width="0.4" opacity=".5"/><line x1="16" y1="3" x2="21" y2="14" stroke="#c8a84e" stroke-width="0.4" opacity=".5"/><line x1="11" y1="14" x2="16" y2="29" stroke="#c8a84e" stroke-width="0.4" opacity=".3"/><line x1="21" y1="14" x2="16" y2="29" stroke="#c8a84e" stroke-width="0.4" opacity=".3"/><text x="16" y="19" text-anchor="middle" font-family="Georgia,serif" font-size="11" font-weight="bold" fill="#c8a84e">L</text></svg><div style="font-size:28px;font-weight:900;color:var(--gold,#d4a843);font-family:Georgia,serif;letter-spacing:3px">Luxyra</div>';
  h += '<div style="font-size:13px;color:rgba(255,255,255,.5);margin-top:4px">Connectez-vous 00e0 votre salon</div></div>';
